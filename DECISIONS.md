...
| D-052 | provisional | No separate Dashboard detail screens. The Dashboard shows the compact state (D-012, D-037); long-term analysis lives in Progress (D-013). Tapping the weight card opens a quick weight entry. |
